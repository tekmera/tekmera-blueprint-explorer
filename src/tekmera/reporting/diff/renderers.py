...
from .diff import BlueprintDiffReport, ModuleChange, ChangeType
...
class DiffReportTextRenderer:
    ...
    def _render_change_analysis(self) -> str:
        ...
        changed_components = [c for c in self.report.module_changes if c.change_type != ChangeType.UNCHANGED]
    ...
    def _render_component_type_section(self, comp_type: str, all_changes: List[ModuleChange]) -> str:
