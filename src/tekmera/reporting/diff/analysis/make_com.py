...
def analyze_make_com_differences(
    ...
    if _has_connection_changes(old_config, new_config):
        ...
        connection_diffs = analyze_connection_differences(old_config, new_config, Platform.MAKE_COM)
        ...
        old_node.is_filter or new_node.is_filter or "filter" in old_config or "filter" in new_config
    ):
        ...
        old_node.is_router or new_node.is_router or "routes" in old_config or "routes" in new_config
    ):
        ...
        router_diffs = analyze_router_differences(old_config, new_config, Platform.MAKE_COM)
        ...
        module_diffs = analyze_module_differences(old_config, new_config, Platform.MAKE_COM)
