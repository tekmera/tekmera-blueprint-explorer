"""
Make.com module count extraction.
"""
...
def module_count(blueprint: Dict[str, Any]) -> ProjectionResult[int]:
    """
    Count modules in Make.com blueprint.
    Make.com exports use the same flow structure as Workfront Fusion.
    ...
    # Also check for orphaned modules (same structure as Workfront Fusion)
    orphans = []
