...
def analyze_module_types(blueprint: Dict[str, Any], platform: Platform = None) -> ProjectionResult[Dict[str, Any]]:
    """
    ...
    if platform == Platform.WORKFRONT_FUSION:
        ...
        raise UnsupportedPlatformError(f"Module types analysis not implemented for platform: {platform}")