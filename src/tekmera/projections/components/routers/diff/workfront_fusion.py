...
def analyze_workfront_fusion_router(old_router: Dict[str, Any], new_router: Dict[str, Any]) -> List[RouterDifference]:
    """
...
def _analyze_route_structure(old_routes: List, new_routes: List) -> List[RouterDifference]:
    ...
    if old_count != new_count:
        ...
        differences.append(RouterDifference(
            field_path="routes",
...
def _analyze_individual_route(old_route: Dict, new_route: Dict, route_index: int) -> List[RouterDifference]:
