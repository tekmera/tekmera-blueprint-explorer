...
def _analyze_individual_condition(
    ...
    if old_field != new_field:
        differences.append(
            FilterDifference(
                field_path=f"conditions.{group_index}.{condition_index}.field",
                old_value=old_field,
                new_value=new_field,
                change_type="modified",
                significance="important",
    ...
    if old_value != new_value:
        ...
        differences.append(
            FilterDifference(
                field_path=f"conditions.{group_index}.{condition_index}.value",
                old_value=old_value,
                new_value=new_value,
                change_type="modified",
...
def _extract_field_name(field_expression: str) -> str:
    ...
    # Make.com might use different field reference patterns
    # Handle common patterns like dot notation or simple names
