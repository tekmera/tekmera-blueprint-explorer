...
def create_make_com_connection(
    ...
    connection_param_name, connection_id = _find_make_connection_parameter(parameters, param_definitions)
...
def _find_make_connection_parameter(parameters: Dict[str, Any], param_definitions: List[Dict[str, Any]]) -> tuple[str, Any]:
    """
