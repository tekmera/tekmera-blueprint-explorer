...
def extract_all_connections(blueprint: Dict[str, Any], platform: Platform) -> List[ConnectionComponent]:
    """
...
def get_unique_connections(connections: List[ConnectionComponent]) -> Dict[str, ConnectionComponent]:
    """
