...
from ..types import create_connection_component, ConnectionComponent
...
def _extract_all_modules_from_flow(flow: List[Dict[str, Any]], path: str = "main") -> List[Dict[str, Any]]:
    """
    ...
    for i, module in enumerate(flow):
        ...
        module_with_context["_extraction_context"] = {
            "path": path,
            "position": i
        }
...
def _extract_connection_from_module(module: Dict[str, Any], blueprint: Dict[str, Any]) -> ConnectionComponent | None:
    """
