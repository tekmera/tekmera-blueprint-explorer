...
def analyze_make_com_module(old_module: Dict[str, Any], new_module: Dict[str, Any]) -> List[ModuleDifference]:
    """
...
def _analyze_make_parameters(old_params: Dict[str, Any], new_params: Dict[str, Any]) -> List[ModuleDifference]:
...
def _analyze_make_settings(old_settings: Dict[str, Any], new_settings: Dict[str, Any]) -> List[ModuleDifference]:
