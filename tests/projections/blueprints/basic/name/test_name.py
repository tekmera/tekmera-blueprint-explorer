...
class TestNameIntegration:
    ...
    def test_platform_auto_detection_workfront_fusion(self):
        ...
        blueprint = {"name": "Auto-detected Fusion", "flow": [], "metadata": {}}

        result = project("blueprints", "basic", "name", blueprint)
    ...
    def test_platform_auto_detection_make_com(self):
        ...
        blueprint = {"name": "Auto-detected Make", "scenario": {"modules": []}}
    ...
    def test_unsupported_platform_detection(self):
        ...
        with pytest.raises(UnsupportedPlatformError) as exc_info:
            project("blueprints", "basic", "name", blueprint)
    ...
    def test_consistent_blueprint_id_generation(self):
        ...
        blueprint1 = {"name": "Test Consistency", "flow": [], "metadata": {}}

        blueprint2 = {"name": "Test Consistency", "flow": [], "metadata": {}}

        result1 = project("blueprints", "basic", "name", blueprint1)
        result2 = project("blueprints", "basic", "name", blueprint2)
    ...
    def test_input_immutability(self):
        ...
        project("blueprints", "basic", "name", blueprint_copy)
