...
from tekmera.projections.single.basic.module_count import module_count
...
class TestModuleCountIntegration:
    ...
    def test_explicit_platform_override(self):
        ...
        result = module_count(blueprint, platform=Platform.WORKFRONT_FUSION)
    ...
    def test_consistent_blueprint_id_generation(self):
        ...
        result1 = module_count(blueprint1)
        result2 = module_count(blueprint2)
    ...
    def test_zero_count_scenarios(self):
        ...
        fusion_result = module_count(fusion_blueprint)
        make_result = module_count(make_blueprint)
